...
export default function TeamList({ initialTeams, onTeamDeleted }: TeamListProps) {
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 flex items-center justify-center z-50" style={{ backgroundColor: "rgba(0, 0, 0, 0.2)" }}>
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <p className="text-gray-500 mb-4">This will permanently delete {selectedTeam?.name} from the team list.</p>
